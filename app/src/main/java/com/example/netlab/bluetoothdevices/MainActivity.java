package com.example.netlab.bluetoothdevices;
...
public class MainActivity extends AppCompatActivity {
    ...
    //该UUID表示串口服务
    static final String SPP_UUID = "0000  0 -0000- 000-8000-00805F9B34FB";
    ...
    class ItemClickEvent implements AdapterView.OnItemClickListener {
        ...
        @Override
        public void onItemClick(AdapterView<?> arg0, View arg , int arg2,
                                long arg3) {
        ...
        public void onClick(View v) {
            if (v == btnSearch)// 搜索蓝牙设备，在BroadcastReceiver显示结果
            {
                if (btAdapt.getState() == BluetoothAdapter.STATE_OFF) {// 如果蓝牙还没开启
                    Toast.makeText(MainActivity.this, "请先打开蓝牙",Toast.LENGTH_LONG)
                            .show();
                    return;
                }
